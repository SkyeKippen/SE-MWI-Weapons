...
C - Capital/Super Weapon (Anything larger)
...
- `TEC_01_Mk1 ""` - Tiny Energy Cannon Mk1 - Turret - A basic energy cannon that doesn't do much on its own, but can be lined up for devestating broadsides.
