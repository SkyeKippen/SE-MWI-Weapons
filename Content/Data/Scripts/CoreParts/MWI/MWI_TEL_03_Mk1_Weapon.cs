...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MWI_TEL_03_Mk1 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MWI_TEL_03_Mk1", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "TEL-03 Mk1", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
