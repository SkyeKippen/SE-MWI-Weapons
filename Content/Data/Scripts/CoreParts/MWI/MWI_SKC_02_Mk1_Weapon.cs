...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition MWI_SKC_02_Mk1 => new WeaponDefinition
        {
            ...
            {
                PartName = "SKC-02 Mk1", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.25f, // Projectile inaccuracy in degrees.
                AimingTolerance = 2.5f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
