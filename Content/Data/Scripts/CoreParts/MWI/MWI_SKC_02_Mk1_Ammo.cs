...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef MWI_SKC_02_Mk1_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "MWI_SKC_02_Mk1_AmmoMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "MWI_SKC_02_Mk1_Ammo", // Unique name used in server overrides and in the terminal (default).  Should be different for each ammoDef used by the same weapon.  Referred to for Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Color = Color(red: 128f, green: 128f, blue: 0f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                                                                             // For no glow, use 0-1
                        ...
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "MWI_TEC_01_Mk1_Ammo", // NOT FINAL // Please always have this Line set, if this Section is enabled.
                        },
                        TextureMode = Normal,
